...
{
    public class HobGoblin_Battle : State<EnemyAI>
    {
        ...
        public HobGoblin_Battle(EnemyAI owner) : base(owner) { }

        public override void Enter()
        {
            DebugUtility.Log("HobGoblin_Battleを起動しました");
            //アニメーションコンポーネント取得
        ...
        public override void Exit()
        {
            ...
            //検知フラグオフ
            m_parameters.m_status.IsFlag = false;
            DebugUtility.Log("HobGoblin_Battleを終了しました");
        }
    }
}
