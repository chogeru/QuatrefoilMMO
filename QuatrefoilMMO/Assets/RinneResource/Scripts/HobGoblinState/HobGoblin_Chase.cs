...
{
    public class HobGoblin_Chase : State<EnemyAI>
    {
        ...
        public HobGoblin_Chase(EnemyAI owner) : base(owner) { }

        public override void Enter()
        {
            DebugUtility.Log("HobGoblin_Chaseを起動しました");
            //アニメーションコンポーネント取得
        ...
        {
            DebugUtility.Log("HobGoblin_Chaseを終了しました");
            //ナビゲーション終了
