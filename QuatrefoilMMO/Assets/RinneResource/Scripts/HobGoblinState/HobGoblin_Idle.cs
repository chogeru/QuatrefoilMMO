...
{
    public class HobGoblin_Idle : State<EnemyAI>
    {
        private Animator m_animator;
        private Parameters m_parameters;

        //コンストラクタ
        public HobGoblin_Idle(EnemyAI owner) : base(owner) { }

        public override void Enter()
        {
            DebugUtility.Log("HobGoblin_Idleを起動しました");
            //アニメーションコンポーネント取得
        ...
        {
            DebugUtility.Log("HobGoblin_Idleを終了しました");
        }
    }
}
