...
{
    public class Gryphon_Chase : State<EnemyAI>
    {
        ...
        //コンストラクタ
        public Gryphon_Chase(EnemyAI owner) : base(owner) { }
        public override void Enter()
        {
            DebugUtility.Log("Gryphon_Chaseを起動しました");
            //アニメーションコンポーネント取得
        ...
        {
            DebugUtility.Log("Gryphon_Chaseを終了しました");
            //ナビゲーション終了
