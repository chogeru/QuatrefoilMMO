...
{
    public class Gryphon_Attack : State<EnemyAI>
    {
        ...
        //コンストラクタ
        public Gryphon_Attack(EnemyAI owner) : base(owner) { }

        public override void Enter()
        {
            DebugUtility.Log("Gryphon_Attackを起動しました");
            //アニメーションコンポーネント取得
        ...
        public override void Exit()
        {
            ...
            DebugUtility.Log("Gryphon_Attackを終了しました");
        }
