...
{
    public class Cobold_Battle : State<EnemyAI>
    {
        ...
        //コンストラクタ
        public Cobold_Battle(EnemyAI owner) : base(owner) { }

        public override void Enter()
        {
            DebugUtility.Log("Cobold_Battleを起動しました");
            //アニメーションコンポーネント取得
        ...
        public override void Exit()
        {
            ...
            //検知フラグオフ
            m_parameters.m_status.IsFlag = false;
            DebugUtility.Log("Cobold_Battleを終了しました");
        }
    }
}
