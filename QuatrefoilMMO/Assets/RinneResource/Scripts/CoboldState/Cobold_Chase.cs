...
{
    public class Cobold_Chase : State<EnemyAI>
    {
        private Animator m_animator;
        private NavMeshAgent m_navmeshagent;
        private Parameters m_parameters;
        private Enemyeye m_enemyeye;
        public Cobold_Chase(EnemyAI owner) : base(owner) { }

        public override void Enter()
        {
            DebugUtility.Log("Cobold_Chaseを起動しました");
            //アニメーションコンポーネント取得
        ...
        {
            DebugUtility.Log("Cobold_Chaseを終了しました");
            //ナビゲーション終了
